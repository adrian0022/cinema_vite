      ...
      <div className="content-wrapper">
        ...
        <nav className={sidebarOpened?'opened':''}>
          <ul>
            ...
            <li>
              <NavLink onClick={closeSidebar} to="/topRatedMovies" className="navlink">
                <TopRatedIcon />
                TopRated
              </NavLink>
            </li>
            <li>
              <NavLink onClick={closeSidebar} to="/upcomingMovies" className="navlink">
                <UpcomingIcon />
                Upcoming
              </NavLink>
            </li>
            <li>
              <NavLink onClick={closeSidebar} to="/nowPlayingMovies" className="navlink">
                <NowPlayingIcon />
                Now Playing
              </NavLink>
            </li>
            <li>
              <NavLink onClick={closeSidebar} to="/popularSeries" className="navlink">
                <PopularTvSeriesIcon />
                Popular TV Series
              </NavLink>
            </li>
            <li>
              <NavLink onClick={closeSidebar} to="/topRatedSeries" className="navlink">
